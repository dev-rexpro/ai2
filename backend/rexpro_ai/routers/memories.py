...
from rexpro_ai.models.memories import Memories, MemoryModel
from rexpro_ai.retrieval.vector.async_client import ASYNC_VECTOR_DB_CLIENT
from rexpro_ai.config import RAG_EMBEDDING_QUERY_PREFIX
from rexpro_ai.utils.access_control import has_permission
from rexpro_ai.utils.auth import get_verified_user
...
async def query_memory(
    ...
    if results and relevance_threshold > 0.0 and results.distances and results.distances[0]:
        from rexpro_ai.retrieval.vector.main import SearchResult
