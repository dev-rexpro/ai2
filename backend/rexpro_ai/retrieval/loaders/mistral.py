...
from rexpro_ai.env import AIOHTTP_CLIENT_SESSION_SSL, GLOBAL_LOG_LEVEL
...
class MistralLoader:
    ...
    def __init__(
        ...
        self.headers = {
            ...
            'User-Agent': 'rexpro-ai-MistralLoader/2.0',  # Helps API provider track usage
        }
    ...
    async def _get_session(self):
        ...
        async with aiohttp.ClientSession(
            connector=connector,
            timeout=timeout,
            headers={'User-Agent': 'rexpro-ai-MistralLoader/2.0'},
