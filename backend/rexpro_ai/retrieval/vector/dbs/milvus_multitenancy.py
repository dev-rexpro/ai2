...
# can't be a legitimate rexpro-ai collection name.
...
class MilvusClient(VectorDBBase):
    ...
    def _get_collection_and_resource_id(self, collection_name: str) -> Tuple[str, str]:
        ...
        WARNING: This mapping relies on current rexpro-ai naming conventions for
        collection names. If rexpro-ai changes how it generates collection names
