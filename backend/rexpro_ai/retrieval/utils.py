...
from rexpro_ai.retrieval.vector.main import GetResult
...
from rexpro_ai.utils.headers import include_user_info_headers
from rexpro_ai.utils.misc import get_message_list
...
def build_loader_from_config(request):
    ...
    from rexpro_ai.retrieval.loaders.main import Loader
...
# Anything else cannot be a real rexpro-ai collection and could break out of
