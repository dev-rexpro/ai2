...
from rexpro_ai.internal.db import Base, get_async_db_context
from rexpro_ai.models.access_grants import AccessGrantModel, AccessGrants
from rexpro_ai.models.groups import Groups
from rexpro_ai.models.users import User, UserModel, UserResponse
...
class CalendarEventTable:
    ...
    async def get_upcoming_events(
        ...
        *grace_ns* widens the SQL lower bound so that events whose start_at
        ...
        time.
        """
        from rexpro_ai.models.users import User as UserRow
