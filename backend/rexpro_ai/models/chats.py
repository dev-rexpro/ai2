...
from rexpro_ai.models.automations import AutomationRun
from rexpro_ai.models.chat_messages import ChatMessage, ChatMessages
from rexpro_ai.models.folders import Folders
from rexpro_ai.models.tags import Tag, TagModel, Tags
from rexpro_ai.utils.misc import sanitize_data_for_db, sanitize_text_for_db
...
class ChatTable:
    ...
    async def insert_shared_chat_by_chat_id(self, chat_id: str, db: AsyncSession | None = None) -> ChatModel | None:
        ...
        from rexpro_ai.models.shared_chats import SharedChats
    ...
    async def delete_shared_chats_by_user_id(self, user_id: str, db: AsyncSession | None = None) -> bool:
        ...
        from rexpro_ai.models.shared_chats import SharedChat as SharedChatTable
        from rexpro_ai.models.shared_chats import SharedChats
