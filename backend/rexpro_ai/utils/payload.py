...
from rexpro_ai.utils.task import prompt_template, prompt_variables_template
...
def remove_open_rexpro_params(params: dict) -> dict:
    """
    Removes rexpro-ai specific parameters from the provided dictionary.

    Args:
        params (dict): The dictionary containing parameters.

    Returns:
        dict: The modified dictionary with rexpro-ai parameters removed.
    """
    open_rexpro_params = {
...
def apply_model_params_to_body_openai(params: dict, form_data: dict) -> dict:
    params = remove_open_rexpro_params(params)
