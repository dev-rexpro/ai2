...
from rexpro_ai.tools.builtin import (
    add_memory,
    calculate_timestamp,
    create_automation,
...
from rexpro_ai.utils.access_control import has_access, has_connection_access, has_permission
...
from rexpro_ai.utils.plugin import load_tool_module_by_id
...
async def get_builtin_tools(
    ...
    if is_builtin_tool_enabled('knowledge'):
        from rexpro_ai.env import ENABLE_KB_EXEC
