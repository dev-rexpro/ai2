...
from rexpro_ai.models.functions import FunctionModel, Functions
...
def replace_imports(content):
    ...
    """
    replacements = {
        'from utils': 'from rexpro_ai.utils',
        'from apps': 'from rexpro_ai.apps',
        'from main': 'from rexpro_ai.main',
        'from config': 'from rexpro_ai.config',
    }
