...
from rexpro_ai.models.auths import Auths
from rexpro_ai.models.groups import GroupForm, GroupModel, Groups, GroupUpdateForm
from rexpro_ai.models.oauth_sessions import OAuthSessions
from rexpro_ai.models.users import Users
from rexpro_ai.retrieval.web.utils import validate_url
from rexpro_ai.utils.auth import create_token, get_password_hash
from rexpro_ai.utils.groups import apply_default_group_assignment
from rexpro_ai.utils.misc import parse_duration
...
from rexpro_ai.env import GLOBAL_LOG_LEVEL
...
async def get_oauth_client_info_with_dynamic_client_registration(
    ...
    try:
        ...
        redirect_base_url = (str(request.app.state.config.REXPRO_URL or request.base_url)).rstrip('/')

        oauth_client_metadata = OAuthClientMetadata(
            client_name='rexpro-ai',
...
class OAuthClientManager:
    ...
    async def handle_callback(self, request, client_id: str, user_id: str, response):
        ...
        redirect_url = (str(request.app.state.config.REXPRO_URL or request.base_url)).rstrip('/')
...
class OAuthManager:
    ...
    async def update_user_groups(self, user, user_data, default_permissions, db=None):
        ...
        log.debug(f'All groups available in rexpro-ai: {[g.name for g in all_available_groups]}')
