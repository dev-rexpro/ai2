...
import { p as push, i as getContext, t as template_effect, y as event, k as get, a as append, b as pop, s as setup_stores, z as sibling, c as child, d as set_text, w as set, f as from_html, e as store_get, q as mutable_source, r as reset, a_ as remove_textarea_child, x as derived_safe_equal } from "../chunks/B-Kw_l3V.js";
...
function CreateKnowledgeBase($$anchor, $$props) {
  ...
  const submitHandler = async () => {
    ...
    const res = await createNewKnowledge(localStorage.token, get(name), get(description), get(accessGrants)).catch((e) => {
      toast.error(`${e}`);
    });
    if (res) {
