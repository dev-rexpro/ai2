...
import { t as template_effect, a as append, B as from_svg, p as push, i as getContext, h as first_child, c as child, r as reset, z as sibling, m as deep_read_state, u as untrack, d as set_text, k as get, y as event, b as pop, e as store_get, s as setup_stores, x as derived_safe_equal, aR as next, f as from_html, o as onMount, w as set, A as tick, q as mutable_source, aV as mutate, j as onDestroy, g as comment, aS as createEventDispatcher, l as legacy_pre_effect, n as legacy_pre_effect_reset, C as deferred_template_effect, $ as $document, v as user_derived } from "../chunks/B-Kw_l3V.js";
import { i as if_block } from "../chunks/DWHK2A9K.js";
import { s as set_attribute, a as set_class, c as clsx, f as bind_select_value, r as remove_input_defaults } from "../chunks/B9yCN616.js";
import { i as init } from "../chunks/CUpGYt-B.js";
import { g as goto } from "../chunks/vYrFh_lq.js";
import { p as page } from "../chunks/B35obKje.js";
import { m as models, p as pinnedNotes, b as showSidebar, k as socket, s as settings, c as config, R as REXPRO_NAME, u as user, a as mobile } from "../chunks/BJ3rUC-5.js";
...
import { s as splitStream, m as copyToClipboard, v as v4, B as convertHeicToJpeg, C as compressImage } from "../chunks/X0cYWxFO.js";
...
import { I as Image, M as Markdown, S as Sparkles, e as equal } from "../chunks/DR1P1jn4.js";
import { c as calendar } from "../chunks/DN4MDugR.js";
import { d as dayjsDuration } from "../chunks/DDd3niey.js";
import { d as Pane_resizer, c as Pane, P as Pane_group, R as RichTextInput } from "../chunks/Bv1TNWY0.js";
import { b as REXPRO_BASE_URL } from "../chunks/CZpnbXda.js";
import { u as uploadFile, g as getFileById } from "../chunks/BipwcWe2.js";
import { c as chatCompletion, a as generateOpenAIChatCompletion } from "../chunks/drrmQgs3.js";
import { d as downloadPdf } from "../chunks/rnYvrP1L.js";
import { e as each, i as index } from "../chunks/qTQza25_.js";
import { X as XMark } from "../chunks/DAqPThR3.js";
import { F as FileItem } from "../chunks/DDFjerJA.js";
...
import { M as MessageInput } from "../chunks/wcPzbA5r.js";
...
import { L as LockClosed, A as AccessControlModal } from "../chunks/BURXHJDK.js";
import { t as toggleNotePinnedStatusById, a as getNoteById, g as getPinnedNoteList, u as updateNoteById, d as deleteNoteById, b as updateNoteAccessGrants } from "../chunks/DnKF8DiH.js";
import { S as Spinner } from "../chunks/gJqE84vs.js";
import { M as MicSolid, A as ArrowUturnLeft } from "../chunks/El29DtH4.js";
import { V as VoiceRecording } from "../chunks/Bsdbht5u.js";
import { C as ConfirmDialog } from "../chunks/Bt_XG8Gm.js";
import { C as ChatBubbleOval } from "../chunks/C1RNAtjy.js";
import "../chunks/DgrNKDk-.js";
import "../chunks/tmhUPuyr.js";
...
var root$e = from_html(`<div class=" text-xs font-medium mb-2"> </div> <div class="flex flex-col gap-1"><!> <div class="flex items-center flex-wrap gap-2 mt-1.5"></div></div> <hr class="my-2 border-gray-50 dark:border-gray-700/10"/>`, 1);
var root_1$4 = from_html(`<option class="bg-gray-50 dark:bg-gray-700"> </option>`);
var root_2$4 = from_html(`<div class="flex items-center mb-1.5 pt-1.5"><div class=" mr-1 flex items-center"><button class="p-0.5 bg-transparent transition rounded-lg"><!></button></div> <div class=" font-medium text-base flex items-center gap-1"><div> </div></div></div> <div class="mt-1 px-1.5"><div class="pb-10"><!> <div class=" text-xs font-medium mb-1"> </div> <div class="w-full"><select class="w-full bg-transparent text-sm outline-hidden"><option class="bg-gray-50 dark:bg-gray-700" disabled=""> </option><!></select></div></div></div>`, 1);
  ...
  var node_1 = child(div_5);
  {
    var consequent = ($$anchor2) => {
      ...
      each(
        div_8,
        5,
        () => (deep_read_state(files()), untrack(() => files().filter((file) => file.type === "image" || ((file == null ? void 0 : file.content_type) ?? "").startsWith("image/")))),
        index,
        ($$anchor3, file) => {
          Image($$anchor3, {
            get src() {
...
var root$d = from_svg(`<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="m19.5 19.5-15-15m0 0v11.25m0-11.25h11.25"></path></svg>`);
...
var root$c = from_html(`<button class=" text-transparent group-hover:text-gray-500 dark:hover:text-gray-300 transition"><!></button>`);
var root_1$3 = from_html(`<button class=" text-transparent group-hover:text-gray-500 dark:hover:text-gray-300 transition"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="size-4"><path stroke-linecap="round" stroke-linejoin="round" d="M15 12H9m12 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"></path></svg></button>`);
var root_2$3 = from_html(`<div><!></div>`);
var root_3$3 = from_html(`<div class=" markdown-prose-sm text-sm"><!></div>`);
var root_4$2 = from_html(`<div class="flex flex-col gap-1 group"><div class="flex items-center justify-between pt-1"><div class="py-1 text-sm font-semibold uppercase min-w-[6rem] text-left rounded-lg transition"> </div> <div class="flex items-center gap-2"><!> <!> <!></div></div> <div class="flex-1"><!></div></div>`);
...
var root$b = from_html(`<div class="space-y-3 pb-12"></div>`);
...
var root$a = from_html(`<span class="text-gray-500 text-sm"> </span>`);
var root_1$2 = from_html(`<div class="text-xs rounded-xl px-2.5 py-3 w-full markdown-prose-xs"><blockquote><div class=" line-clamp-3"> </div></blockquote></div>`);
var root_2$2 = from_html(`<button type="button"><!> <span class="block whitespace-nowrap overflow-hidden text-ellipsis leading-none pr-0.5"> </span></button>`);
var root_3$2 = from_html(`<option class="bg-gray-50 dark:bg-gray-700"> </option>`);
var root_4$1 = from_html(`<select class=" bg-transparent rounded-lg py-1 px-2 -mx-0.5 text-sm outline-hidden w-full text-right pr-5"></select>`);
var root_5$1 = from_html(`<div slot="menu" class="flex items-center justify-between gap-2 w-full pr-1"><div><!></div> <!></div>`);
var root_6$1 = from_html(`<div class="flex items-center mb-1.5 pt-1.5"><div class="flex items-center mr-1"><button class="p-0.5 bg-transparent transition rounded-lg"><!></button></div> <div class=" font-medium text-base flex items-center gap-1"><div> </div> <div><!></div></div></div> <div class="flex flex-col items-center flex-1 @container"><div class=" flex flex-col justify-between w-full overflow-y-auto h-full"><div class="mx-auto w-full md:px-0 h-full relative"><div class=" flex flex-col h-full"><div class=" pb-2.5 flex flex-col justify-between w-full flex-auto overflow-auto h-0 scrollbar-hidden" id="messages-container"><div class=" h-full w-full flex flex-col"><div class="flex-1 p-1"><!></div></div></div> <div class=" pb-[1rem]"><!> <!></div></div></div></div></div>`, 1);
...
<selection>${(_e = selectedContent()) == null ? void 0 : _e.text}</selection>` : "");
    ...
    const chatMessages = JSON.parse(JSON.stringify([
...
var root$9 = from_html(`<div class=" px-3.5 py-2.5 h-screen max-h-dvh flex flex-col"><!></div>`);
var root_1$1 = from_html(`<div class=" absolute -left-1.5 -right-1.5 -top-0 -bottom-0 z-20 cursor-col-resize bg-transparent"></div>`);
var root_2$1 = from_html(`<div class="flex max-h-full min-h-full"><div class="w-full pt-2 bg-white dark:shadow-lg dark:bg-gray-850 z-40 pointer-events-auto overflow-y-auto scrollbar-hidden flex flex-col px-2"><!></div></div>`);
...
function NotePanel($$anchor, $$props) {
  ...
  var node = first_child(fragment);
  {
    ...
    if_block(node, ($$render) => {
      ...
      else if (show()) $$render(consequent_3, 1);
    });
  }
  append($$anchor, fragment);
  pop();
}
var root$8 = from_svg(`<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M12 18.75a6 6 0 0 0 6-6v-1.5m-6 7.5a6 6 0 0 1-6-6v-1.5m6 7.5v3.75m-3.75 0h7.5M12 15.75a3 3 0 0 1-3-3V4.5a3 3 0 1 1 6 0v8.25a3 3 0 0 1-3 3Z"></path></svg>`);
...
var root$6 = from_html(`<div slot="content"><div class="min-w-[170px] text-sm rounded-xl p-1 z-50 bg-white dark:bg-gray-850 dark:text-white shadow-lg font-primary"><button class="flex rounded-md py-1.5 px-3 w-full hover:bg-gray-50 dark:hover:bg-gray-800 transition"><div class=" self-center mr-2"><!></div> <div class=" self-center truncate"> </div></button> <button class="flex rounded-md py-1.5 px-3 w-full hover:bg-gray-50 dark:hover:bg-gray-800 transition"><div class=" self-center mr-2"><!></div> <div class=" self-center truncate"> </div></button> <button class="flex rounded-md py-1.5 px-3 w-full hover:bg-gray-50 dark:hover:bg-gray-800 transition"><div class=" self-center mr-2"><!></div> <div class=" self-center truncate"> </div></button></div></div>`);
function RecordMenu($$anchor, $$props) {
  ...
  const i18n = getContext("i18n");
  let show = prop($$props, "show", 12, false);
  prop($$props, "className", 8, "max-w-[170px]");
  ...
  Dropdown($$anchor, {
    ...
    $$slots: {
      ...
      content: ($$anchor2, $$slotProps) => {
        ...
        Mic(node_1, { className: "size-4", strokeWidth: "2" });
        reset(div_2);
        var div_3 = sibling(div_2, 2);
        var text = child(div_3, true);
        reset(div_3);
        ...
        CursorArrowRays(node_2, { className: "size-4", strokeWidth: "2" });
        reset(div_4);
        ...
        CloudArrowUp(node_3, { className: "size-4", strokeWidth: "2" });
        reset(div_6);
        var div_7 = sibling(div_6, 2);
...
var root$4 = from_svg(`<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="m15 15 6-6m0 0-6-6m6 6H9a6 6 0 0 0 0 12h3"></path></svg>`);
...
var root$3 = from_html(`<div slot="content"><div class="min-w-[170px] text-sm rounded-xl p-1 z-50 bg-white dark:bg-gray-850 dark:text-white shadow-lg font-primary"><button class="flex rounded-md py-1.5 px-3 w-full hover:bg-gray-50 dark:hover:bg-gray-800 transition"><div class=" self-center mr-2"><!></div> <div class=" self-center truncate"> </div></button> <button class="flex rounded-md py-1.5 px-3 w-full hover:bg-gray-50 dark:hover:bg-gray-800 transition"><div class=" self-center mr-2"><!></div> <div class=" self-center truncate"> </div></button></div></div>`);
  ...
  Dropdown($$anchor, {
    ...
    $$slots: {
      ...
      content: ($$anchor2, $$slotProps) => {
        ...
        var div_2 = child(button);
        var node_1 = child(div_2);
        Sparkles(node_1, { className: "size-4", strokeWidth: "2" });
        reset(div_2);
        var div_3 = sibling(div_2, 2);
        var text = child(div_3, true);
        reset(div_3);
        ...
        var div_4 = child(button_1);
        var node_2 = child(div_4);
        ChatBubbleOval(node_2, { className: "size-4", strokeWidth: "2" });
        reset(div_4);
        var div_5 = sibling(div_4, 2);
        var text_1 = child(div_5, true);
        reset(div_5);
...
var root$1 = from_html(`<div class=" text-sm text-gray-500"> <span class="  font-semibold"> </span>.</div>`);
var root_1 = from_html(`<div class=" absolute top-0 bottom-0 left-0 right-0 flex"><div class="m-auto"><!></div></div>`);
var root_2 = from_html(`<button id="sidebar-toggle-button" class=" cursor-pointer flex rounded-lg hover:bg-gray-100 dark:hover:bg-gray-850 transition cursor-"><div class=" self-center p-1.5"><!></div></button>`);
var root_3 = from_html(`<div><!></div>`);
var root_4 = from_html(`<button class=" self-center dark:hover:text-white transition" id="generate-title-button"><!></button>`);
var root_5 = from_html(`<div class="flex self-center items-center space-x-1.5 z-10 translate-y-[0.5px] -translate-x-[0.5px] pl-2"><!></div>`);
var root_6 = from_html(`<div><div class="flex items-center gap-0.5 self-center min-w-fit" dir="ltr"><button class="self-center p-1 hover:enabled:bg-black/5 dark:hover:enabled:bg-white/5 dark:hover:enabled:text-white hover:enabled:text-black rounded-md transition disabled:cursor-not-allowed disabled:text-gray-500 disabled:hover:text-gray-500"><!></button> <button class="self-center p-1 hover:enabled:bg-black/5 dark:hover:enabled:bg-white/5 dark:hover:enabled:text-white hover:enabled:text-black rounded-md transition disabled:cursor-not-allowed disabled:text-gray-500 disabled:hover:text-gray-500"><!></button></div></div>`);
var root_7 = from_html(`<button class="p-1.5 bg-transparent hover:bg-white/5 transition rounded-lg"><!></button>`);
var root_8 = from_html(`<!> <!> <!>`, 1);
var root_9 = from_html(`<div class="p-1 bg-transparent hover:bg-white/5 transition rounded-lg"><!></div>`);
var root_10 = from_html(`<button class="shrink-0 bg-gray-50 hover:bg-gray-100 text-black dark:bg-gray-850 dark:hover:bg-gray-800 dark:text-white transition px-2.5 py-1 rounded-full flex gap-1.5 items-center text-sm"><!> </button>`);
var root_11 = from_html(`<div class="shrink-0 text-xs text-gray-500 px-2 py-1"> </div>`);
var root_12 = from_html(`<span> </span>`);
var root_13 = from_html(`<div class="flex items-center gap-1 px-1 min-w-fit"><div> </div> <div> </div></div>`);
var root_14 = from_html(`<div></div>`);
var root_15 = from_html(`<div><div class="shrink-0 w-full flex justify-between items-center px-3.5 mb-1.5"><div class="w-full min-w-0 flex items-center"><!> <input class="w-full text-2xl font-medium bg-transparent outline-hidden" type="text" required=""/> <!> <div class="flex items-center gap-0.5 shrink-0 translate-x-1"><!> <!> <!></div></div></div> <div class="  px-2.5"><div class=" flex w-full bg-transparent overflow-x-auto scrollbar-none"><div class="flex gap-0.5 items-center text-xs font-medium text-gray-500 dark:text-gray-500 w-fit"><button class=" flex items-center gap-1 w-fit py-1 px-1.5 rounded-lg min-w-fit"><!></button> <!></div></div></div> <div class=" flex-1 w-full h-full overflow-auto px-3.5 relative" id="note-content-container"><!> <!></div></div>`);
var root_16 = from_html(`<div class="flex-1 w-full"><!></div>`);
var root_17 = from_html(`<button class="p-2 flex justify-center items-center hover:bg-gray-50 dark:hover:bg-gray-800 rounded-full transition shrink-0" type="button"><!></button>`);
var root_18 = from_html(`<div class="cursor-pointer p-2.5 flex rounded-full border border-gray-50 bg-white dark:border-none dark:bg-gray-850 hover:bg-gray-50 dark:hover:bg-gray-800 transition shadow-xl"><!></div>`);
var root_19 = from_html(`<div class="cursor-pointer flex gap-0.5 rounded-full border border-gray-50 dark:border-gray-850/30 dark:bg-gray-850 transition shadow-xl"><!></div> <!>`, 1);
var root_20 = from_html(`<div class="relative flex-1 w-full h-full flex justify-center pt-[11px]" id="note-editor"><!></div> <div class="absolute z-50 bottom-0 right-0 p-3.5 flex select-none"><div class="flex flex-col gap-2 justify-end"><!></div></div>`, 1);
...
function NoteEditor($$anchor, $$props) {
  ...
  const [$$stores, $$cleanup] = setup_stores();
  const editorHtml = mutable_source();
  ...
  const init$1 = async () => {
    ...
    if (res) {
      set(note, res);
      if (!Array.isArray((_a = get(note)) == null ? void 0 : _a.access_grants)) {
        mutate(note, get(note).access_grants = []);
      }
      set(files, res.data.files || []);
      if ((_b = get(note)) == null ? void 0 : _b.write_access) {
        (_c = $socket()) == null ? void 0 : _c.emit("join-note", { note_id: id(), auth: { token: localStorage.token } });
        (_d = $socket()) == null ? void 0 : _d.on("note-events", noteEventHandler);
      }
    } else {
      goto("/");
      return;
    ...
    debounceTimeout = setTimeout(
      async () => {
        ...
        await updateNoteById(localStorage.token, id(), {
          ...
          access_grants: ((_b = get(note)) == null ? void 0 : _b.access_grants) ?? []
        }).catch((e) => {
          toast.error(`${e}`);
        });
      },
...
${content}
    ...
    if (res) {
      ...
      try {
        ...
        /* @__PURE__ */ console.error("Error parsing JSON response:", e);
  ...
  const stopResponseHandler = async () => {
    ...
    /* @__PURE__ */ console.log("stopResponse", get(stopResponseFlag));
  };
  const uploadFileHandler = async (file) => {
    ...
    try {
      ...
      if (uploadedFile) {
        /* @__PURE__ */ console.log("File upload completed:", uploadedFile);
        ...
        fileItem.collection_name = ((_g = uploadedFile == null ? void 0 : uploadedFile.meta) == null ? void 0 : _g.collection_name) || (uploadedFile == null ? void 0 : uploadedFile.collection_name);
...
`;
  ...
  const noteEventHandler = async (_note) => {
    ...
    if (_note.access_grants && _note.access_grants !== get(note).access_grants) {
      mutate(note, get(note).access_grants = _note.access_grants);
    }
    ...
    for (const file of get(files)) {
      if (file.type === "image" || ((file == null ? void 0 : file.content_type) ?? "").startsWith("image/")) {
  ...
  onMount(async () => {
    var _a, _b, _c, _d, _e;
    await tick();
    if ((_a = $settings()) == null ? void 0 : _a.models) {
      set(selectedModelId, (_b = $settings()) == null ? void 0 : _b.models[0]);
    } else if ((_c = $config()) == null ? void 0 : _c.default_models) {
      set(selectedModelId, (_d = $config()) == null ? void 0 : _d.default_models.split(",")[0]);
    } else {
      set(selectedModelId, "");
    }
    if (get(selectedModelId)) {
  ...
  legacy_pre_effect(() => (get(note), marked), () => {
    var _a, _b, _c, _d, _e, _f;
    set(editorHtml, ((_c = (_b = (_a = get(note)) == null ? void 0 : _a.data) == null ? void 0 : _b.content) == null ? void 0 : _c.html) || (((_f = (_e = (_d = get(note)) == null ? void 0 : _d.data) == null ? void 0 : _e.content) == null ? void 0 : _f.md) ? marked.parse(get(note).data.content.md) : ""));
  });
  ...
  head("okwkxt", ($$anchor2) => {
	...
	`;
      ...
      [
        () => (get(note), $REXPRO_NAME(), untrack(() => {
          var _a, _b, _c, _d;
          return ((_a = get(note)) == null ? void 0 : _a.title) ? `${((_b = get(note)) == null ? void 0 : _b.title.length) > 30 ? `${(_c = get(note)) == null ? void 0 : _c.title.slice(0, 30)}...` : (_d = get(note)) == null ? void 0 : _d.title} • ${$REXPRO_NAME()}` : `${$REXPRO_NAME()}`;
        }))
      ]
    );
  });
    ...
    var consequent = ($$anchor2) => {
      {
        let $0 = derived_safe_equal(() => ($user(), untrack(() => {
          var _a, _b, _c, _d;
          return ((_c = (_b = (_a = $user()) == null ? void 0 : _a.permissions) == null ? void 0 : _b.sharing) == null ? void 0 : _c.notes) || ((_d = $user()) == null ? void 0 : _d.role) === "admin";
        })));
        let $1 = derived_safe_equal(() => ($user(), untrack(() => {
          var _a, _b, _c, _d;
          return ((_c = (_b = (_a = $user()) == null ? void 0 : _a.permissions) == null ? void 0 : _b.sharing) == null ? void 0 : _c.public_notes) || ((_d = $user()) == null ? void 0 : _d.role) === "admin";
        })));
        ...
        AccessControlModal($$anchor2, {
          ...
          onChange: async () => {
            if (id()) {
              try {
                await updateNoteAccessGrants(localStorage.token, id(), get(note).access_grants ?? []);
          ...
          get accessGrants() {
            return get(note).access_grants;
          },
          set accessGrants($$value) {
            mutate(note, get(note).access_grants = $$value);
          },
          $$legacy: true
        });
      }
    ...
    children: ($$anchor2, $$slotProps) => {
      ...
      Pane(node_4, {
        ...
        children: ($$anchor3, $$slotProps2) => {
            ...
            var alternate_2 = ($$anchor4) => {
              ...
              var node_13 = child(div_10);
              {
                var consequent_5 = ($$anchor5) => {
                  ...
                  var node_14 = first_child(fragment_4);
                  {
                    var consequent_4 = ($$anchor6) => {
                      ...
                      ArrowUturnLeft(node_15, { className: "size-4" });
                      reset(button_2);
                      var button_3 = sibling(button_2, 2);
                      var node_16 = child(button_3);
                      ArrowUturnRight(node_16, { className: "size-4" });
                      reset(button_3);
                      reset(div_12);
                      reset(div_11);
                      template_effect(
                  ...
                  var node_19 = sibling(node_17, 2);
                  {
                    ...
                    Tooltip(node_19, {
                      ...
                      children: ($$anchor6, $$slotProps3) => {
                        ...
                        AdjustmentsHorizontalOutline(node_20, {});
                        reset(button_5);
                ...
                if_block(node_13, ($$render) => {
                  if (get(note), untrack(() => {
                    var _a;
                    return (_a = get(note)) == null ? void 0 : _a.write_access;
                  })) $$render(consequent_5);
                });
              }
              var node_21 = sibling(node_13, 2);
              {
                ...
                NoteMenu(node_21, {
                  ...
                  onPin: async () => {
                    ...
                    set(note, await getNoteById(localStorage.token, get(note).id));
              ...
              var node_23 = sibling(node_21, 2);
              {
                var consequent_6 = ($$anchor5) => {
                  ...
                  var node_24 = child(button_6);
                  LockClosed(node_24, { strokeWidth: "2.5", className: "size-3.5" });
                  var text_2 = sibling(node_24);
                  reset(button_6);
                  template_effect(
                    ($0) => {
                      button_6.disabled = (get(note), $user(), untrack(() => {
                        var _a, _b, _c;
                ...
                var alternate = ($$anchor5) => {
                  ...
                  template_effect(($0) => set_text(text_3, $0), [
                    () => ($i18n(), untrack(() => $i18n().t("Read-Only Access")))
                  ]);
              ...
              var node_25 = child(button_7);
              {
                ...
                var d = user_derived(() => (deep_read_state(dayjs2), get(note), untrack(() => dayjs2(get(note).created_at / 1e6).isSame(dayjs2(), "day"))));
                ...
                var d_1 = user_derived(() => (deep_read_state(dayjs2), get(note), untrack(() => dayjs2(get(note).created_at / 1e6).isSame(dayjs2().subtract(1, "day"), "day"))));
                ...
                var d_2 = user_derived(() => (deep_read_state(dayjs2), get(note), untrack(() => dayjs2(get(note).created_at / 1e6).isSame(dayjs2().subtract(1, "week"), "week"))));
                ...
                if_block(node_25, ($$render) => {
                  ...
                  else if (get(d_1)) $$render(consequent_8, 1);
                  else if (get(d_2)) $$render(consequent_9, 2);
                  else $$render(alternate_1, -1);
                });
              }
              reset(button_7);
              var node_26 = sibling(button_7, 2);
              {
                ...
                if_block(node_26, ($$render) => {
                  if (get(editor)) $$render(consequent_10);
                });
              }
              reset(div_17);
              reset(div_16);
              ...
              var node_27 = child(div_21);
              {
                var consequent_11 = ($$anchor5) => {
                  var div_22 = root_14();
                  template_effect(() => set_class(div_22, 1, `w-full h-full fixed top-0 left-0 ${get(streaming) ? "" : " backdrop-blur-xs  bg-white/10 dark:bg-gray-900/10"} flex items-center justify-center z-10 cursor-not-allowed`));
              ...
              var node_28 = sibling(node_27, 2);
              {
                ...
                let $1 = derived_safe_equal(() => (get(note), untrack(() => `note:${get(note).id}`)));
                let $2 = derived_safe_equal(() => ($i18n(), untrack(() => $i18n().t("Write something..."))));
                let $3 = derived_safe_equal(() => (get(versionIdx), get(editing), get(note), untrack(() => {
                  var _a;
                  return get(versionIdx) === null && !get(editing) && ((_a = get(note)) == null ? void 0 : _a.write_access);
                })));
                bind_this(
                  RichTextInput(node_28, {
                    get id() {
                      return get($0);
                    },
                    ...
                    $$events: {
                      paste: async (e) => {
                        ...
                        /* @__PURE__ */ console.log("Clipboard data:", clipboardData);
                        if (clipboardData && clipboardData.items) {
                          /* @__PURE__ */ console.log("Clipboard data items:", clipboardData.items);
                          for (const item of clipboardData.items) {
                            /* @__PURE__ */ console.log("Clipboard item:", item);
          ...
          reset(div_1);
          var div_23 = sibling(div_1, 2);
          var div_24 = child(div_23);
          var node_29 = child(div_24);
          {
            var consequent_12 = ($$anchor4) => {
              var div_25 = root_16();
              var node_30 = child(div_25);
              VoiceRecording(node_30, {
                  ...
                  children: ($$anchor5, $$slotProps3) => {
                    ...
                    var node_32 = first_child(fragment_6);
                    {
                      var consequent_13 = ($$anchor6) => {
                        ...
                        Spinner(node_33, { className: "size-5" });
                        reset(button_8);
                      ...
                      var alternate_3 = ($$anchor6) => {
                        AIMenu($$anchor6, {
                          ...
                          children: ($$anchor7, $$slotProps4) => {
                            var div_27 = root_18();
                            var node_34 = child(div_27);
                            SparklesSolid(node_34, {});
                            reset(div_27);
                      ...
                      if_block(node_32, ($$render) => {
                        if (get(editing)) $$render(consequent_13);
                ...
                children: ($$anchor5, $$slotProps3) => {
                  {
                    ...
                    Tooltip($$anchor5, {
                      ...
                      children: ($$anchor6, $$slotProps4) => {
                        ...
                        MicSolid(node_36, { className: "size-4.5" });
                        reset(div_28);
            ...
            if_block(node_29, ($$render) => {
              if (get(recording)) $$render(consequent_12);
        ...
        children: ($$anchor3, $$slotProps2) => {
          ...
          var node_38 = first_child(fragment_9);
          {
            ...
            if_block(node_38, ($$render) => {
              if (get(selectedPanel) === "chat") $$render(consequent_14);
              else if (get(selectedPanel) === "settings") $$render(consequent_15, 1);
            });
          }
...
var root = from_html(`<div id="note-container"><!></div>`);
function _page($$anchor, $$props) {
  ...
  var node = first_child(fragment);
  {
    var consequent = ($$anchor2) => {
      ...
      reset(div);
      template_effect(() => set_class(div, 1, `w-full h-full ${$showSidebar() ? "md:max-w-[calc(100%-var(--sidebar-width))]" : ""}`));
      append($$anchor2, div);
    };
    if_block(node, ($$render) => {
