...
import { p as push, i as getContext, c as child, k as get, z as sibling, r as reset, t as template_effect, u as untrack, d as set_text, y as event, a as append, g as comment, h as first_child, w as set, aR as next, v as user_derived, m as deep_read_state, x as derived_safe_equal, b as pop, e as store_get, s as setup_stores, q as mutable_source, f as from_html, o as onMount, A as tick, j as onDestroy, l as legacy_pre_effect, n as legacy_pre_effect_reset, C as deferred_template_effect, $ as $document, aV as mutate, aW as text, b1 as invalidate_inner_signals } from "../chunks/B-Kw_l3V.js";
import { i as if_block } from "../chunks/DWHK2A9K.js";
import { i as init } from "../chunks/CUpGYt-B.js";
import { R as REXPRO_NAME, m as models, u as user, c as config, f as functions, s as settings } from "../chunks/BJ3rUC-5.js";
import { b as getFunctionList, l as loadFunctionByUrl, c as createNewFunction, g as getFunctions, d as deleteFunctionById, t as toggleFunctionById, e as toggleGlobalById, a as getFunctionById, f as exportFunctions } from "../chunks/Bw_Wh1To.js";
...
import { V as ValvesModal, H as Heart } from "../chunks/BEWbf6Xv.js";
import { I as ImportModal, M as ManifestModal } from "../chunks/Cr8AdAnY.js";
...
import { l as capitalizeFirstLetter } from "../chunks/X0cYWxFO.js";
import { S as Spinner } from "../chunks/gJqE84vs.js";
var root$2 = from_html(`<div class="flex gap-2 justify-between items-center px-3 py-1.5 text-sm font-medium cursor-pointerrounded-md"><div class="flex gap-2 items-center"><!> <div class="flex items-center"> </div></div> <div><!></div></div> <hr class="border-gray-50 dark:border-gray-850/30 my-1"/>`, 1);
var root_1$1 = from_html(`<div slot="content"><div class="min-w-[180px] rounded-xl p-1 border border-gray-100 dark:border-gray-800 z-50 bg-white dark:bg-gray-850 dark:text-white shadow-sm"><!> <button class="select-none flex gap-2 items-center px-3 py-1.5 text-sm font-medium cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 rounded-md w-full"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4"><path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L6.832 19.82a4.5 4.5 0 01-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 011.13-1.897L16.863 4.487zm0 0L19.5 7.125"></path></svg> <div class="flex items-center"> </div></button> <button class="select-none flex gap-2 items-center px-3 py-1.5 text-sm font-medium cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 rounded-md w-full"><!> <div class="flex items-center"> </div></button> <button class="select-none flex gap-2 items-center px-3 py-1.5 text-sm font-medium cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 rounded-md w-full"><!> <div class="flex items-center"> </div></button> <button class="select-none flex gap-2 items-center px-3 py-1.5 text-sm font-medium cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 rounded-md w-full"><!> <div class="flex items-center"> </div></button> <hr class="border-gray-50 dark:border-gray-850/30 my-1"/> <button class="select-none flex gap-2 items-center px-3 py-1.5 text-sm font-medium cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 rounded-md w-full"><!> <div class="flex items-center"> </div></button></div></div>`);
    ...
    $$slots: {
      ...
      content: ($$anchor2, $$slotProps) => {
        ...
        var node_1 = child(div_1);
        {
          ...
          var d = user_derived(() => (deep_read_state(func()), untrack(() => ["filter", "action"].includes(func().type))));
          if_block(node_1, ($$render) => {
            if (get(d)) $$render(consequent);
          });
        }
        var button = sibling(node_1, 2);
        var div_6 = sibling(child(button), 2);
        ...
        GarbageBin(node_7, { strokeWidth: "2" });
...
var root_1 = from_html(`<button class="flex text-xs items-center space-x-1 px-3 py-1.5 rounded-xl bg-gray-50 hover:bg-gray-100 dark:bg-gray-850 dark:hover:bg-gray-800 dark:text-gray-200 transition"><div class=" self-center font-medium line-clamp-1"> </div></button> <!>`, 1);
var root_2 = from_html(`<div class="cursor-pointer px-2 py-1.5 rounded-xl bg-black text-white dark:bg-white dark:text-black transition font-medium text-sm flex items-center"><!> <div class=" hidden md:block md:ml-1 text-xs"> </div></div>`);
...
var root_5 = from_html(`<div class=" flex items-center gap-1.5"><div class=" text-xs font-semibold px-1 rounded-sm uppercase line-clamp-1 bg-gray-500/20 text-gray-700 dark:text-gray-200"> </div> <div class="line-clamp-1 text-sm"> </div> <!></div>`);
...
var root_10 = from_html(`<div class=" flex space-x-4 cursor-pointer w-full px-2 py-2 dark:hover:bg-white/5 hover:bg-black/5 rounded-xl"><a class=" flex flex-1 space-x-3.5 cursor-pointer w-full"><div class="flex items-center text-left"><div class=" flex-1 self-center pl-1"><!> <div class="flex gap-1.5 px-1"><div class="text-xs text-gray-500 shrink-0"><!></div> <div class=" text-xs overflow-hidden text-ellipsis line-clamp-1"> </div></div></div></div></a> <div class="flex flex-row gap-0.5 self-center"><!> <div class=" self-center mx-1"><!></div></div></div>`);
var root_11 = from_html(`<div class="px-3 my-2 gap-1 lg:gap-2 grid lg:grid-cols-2"></div>`);
...
var root_13 = from_html(`<div class=" my-16"><div class=" text-xl font-medium mb-1 line-clamp-1"> </div> <a class=" flex cursor-pointer items-center justify-between hover:bg-gray-50 dark:hover:bg-gray-850 w-full mb-2 px-3.5 py-1.5 rounded-xl transition" href="https://rexpro-ai.rexpro.com/functions" target="_blank"><div class=" self-center"><div class=" font-semibold line-clamp-1"> </div> <div class=" text-sm line-clamp-1"> </div></div> <div><div><!></div></div></a></div>`);
var root_14 = from_html(`<div class=" text-sm text-gray-500 truncate"> <span class="  font-semibold"> </span>.</div>`);
var root_15 = from_html(`<div class="text-sm text-gray-500"><div class=" bg-yellow-500/20 text-yellow-700 dark:text-yellow-200 rounded-lg px-4 py-3"><div> </div> <ul class=" mt-1 list-disc pl-4 text-xs"><li> </li> <li> </li></ul></div> <div class="my-3"> </div></div>`);
var root_16 = from_html(`<div class="px-4.5 w-full"><div class="flex flex-col gap-1 px-1 mt-2.5 mb-2"><div class="flex justify-between items-center mb-1 w-full"><input id="documents-import-input" type="file" accept=".json" hidden=""/> <div class="flex justify-between items-center w-full"><div class="flex items-center md:self-center text-xl font-medium px-0.5 gap-2 shrink-0"><div> </div> <div class="text-lg font-medium text-gray-500 dark:text-gray-500"> </div></div> <div class="flex w-full justify-end gap-1.5"><!> <!></div></div></div></div> <div class="py-2 bg-white dark:bg-gray-900 rounded-3xl border border-gray-100/30 dark:border-gray-850/30"><div class="px-3.5 flex flex-1 items-center w-full space-x-2 py-0.5 pb-2"><div class="flex flex-1"><div class=" self-center ml-1 mr-3"><!></div> <input class=" w-full text-sm pr-4 py-1 rounded-r-xl outline-hidden bg-transparent"/> <!></div></div> <div class="px-3 flex w-full bg-transparent overflow-x-auto scrollbar-none"><div class="flex gap-0.5 w-fit text-center text-sm rounded-full bg-transparent px-0.5 whitespace-nowrap"><!> <!></div></div> <!></div> <!></div> <!> <!> <!> <!>`, 1);
var root_17 = from_html(`<div class="w-full h-full flex justify-center items-center"><!></div>`);
...
function Functions($$anchor, $$props) {
  ...
  const setFilteredItems = () => {
    set(filteredItems, (get(functions$1) ?? []).filter((f) => {
      var _a, _b, _c, _d, _e;
      return (get(selectedType) !== "" ? f.type === get(selectedType) : true) && (get(query) === "" || f.name.toLowerCase().includes(get(query).toLowerCase()) || f.id.toLowerCase().includes(get(query).toLowerCase()) || (((_a = f.user) == null ? void 0 : _a.name) || "").toLowerCase().includes(get(query).toLowerCase()) || (((_b = f.user) == null ? void 0 : _b.email) || "").toLowerCase().includes(get(query).toLowerCase()) || (((_c = f.user) == null ? void 0 : _c.username) || "").toLowerCase().includes(get(query).toLowerCase())) && (get(viewOption) === "" || get(viewOption) === "created" && f.user_id === ((_d = $user()) == null ? void 0 : _d.id) || get(viewOption) === "shared" && f.user_id !== ((_e = $user()) == null ? void 0 : _e.id));
  ...
  legacy_pre_effect(() => (get(functions$1), get(selectedType), get(viewOption)), () => {
    if (get(functions$1) && get(selectedType) !== void 0 && get(viewOption) !== void 0) {
      setFilteredItems();
    }
  });
        ...
        $$events: {
          confirm: () => {
            ...
            reader.onload = async (event2) => {
              ...
              /* @__PURE__ */ console.log(_functions);
              ...
              set(functions$1, await getFunctionList(localStorage.token));
              _functions.set(await getFunctions(localStorage.token));
              models.set(await getModels(localStorage.token, ((_b = (_a = $config()) == null ? void 0 : _a.features) == null ? void 0 : _b.enable_direct_connections) && (((_c = $settings()) == null ? void 0 : _c.directConnections) ?? null), false, true));
              set(importFiles, null);
              mutate(functionsImportInputElement, get(functionsImportInputElement).value = "");
            };
