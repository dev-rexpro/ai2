import "./DKem_M_z.js";
import "./DwLkIEu4.js";
import { p as push, i as getContext, l as legacy_pre_effect, m as deep_read_state, n as legacy_pre_effect_reset, h as first_child, c as child, r as reset, y as event, a as append, k as get, z as sibling, t as template_effect, u as untrack, w as set, d as set_text, b as pop, e as store_get, s as setup_stores, q as mutable_source, A as tick, x as derived_safe_equal, f as from_html } from "./B-Kw_l3V.js";
...
import { n as nameToId, e as extractFrontmatter, f as formatSkillName } from "./X0cYWxFO.js";
import { C as CodeEditor } from "./DgrNKDk-.js";
...
var root_1 = from_html(`<input class="w-full text-2xl font-medium bg-transparent outline-hidden font-primary" type="text" required=""/>`);
var root_2 = from_html(`<div class="text-sm text-gray-500 shrink-0"> </div>`);
var root_3 = from_html(`<input class="w-full text-sm disabled:text-gray-500 bg-transparent outline-hidden" type="text" required=""/>`);
var root_4 = from_html(`<input class="w-full text-sm bg-transparent outline-hidden" type="text" required=""/>`);
var root_5 = from_html(`<div class="text-sm text-gray-500"><div class=" bg-yellow-500/20 text-yellow-700 dark:text-yellow-200 rounded-lg px-4 py-3"><div> </div> <ul class=" mt-1 list-disc pl-4 text-xs"><li> </li> <li> </li></ul></div> <div class="my-3"> </div></div>`);
var root_6 = from_html(`<div class=" flex flex-col justify-between w-full overflow-y-auto h-full"><div class="mx-auto w-full md:px-0 h-full"><form class=" flex flex-col max-h-[100dvh] h-full"><div class="flex flex-col flex-1 overflow-auto h-0 rounded-lg"><div class="w-full mb-2 flex flex-col gap-0.5"><div class="flex w-full items-center"><div class=" shrink-0 mr-2"><!></div> <div class="flex-1"><!></div> <div><!></div></div> <div class=" flex gap-2 px-1 items-center"><!> <!></div></div> <div class="mb-2 flex-1 overflow-auto h-0 rounded-lg"><!></div> <div class="pb-3 flex justify-between"><div class="flex-1 pr-3"><div class="text-xs text-gray-500 line-clamp-2"><span class=" font-semibold dark:text-gray-200"> </span> <br/>— <span class=" font-medium dark:text-gray-400"> </span></div></div> <button class="px-3.5 py-1.5 text-sm font-medium bg-black hover:bg-gray-900 text-white dark:bg-white dark:text-black dark:hover:bg-gray-100 transition rounded-full" type="submit"> </button></div></div></form></div></div> <!>`, 1);
...
author: rexpro-ai
author_url: https://github.com/rexpro-ai
funding_url: https://github.com/rexpro-ai
version: 0.1
"""
...
class Filter:
    ...
    def __init__(self):
        ...
        # implementations, informing the rexpro to defer file-related operations to designated methods within this class.
...
`;
  ...
  legacy_pre_effect(
    () => (deep_read_state(name()), deep_read_state(edit()), deep_read_state(clone()), nameToId),
    () => {
      if (name() && !edit() && !clone()) {
        id(nameToId(name()));
      }
