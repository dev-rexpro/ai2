...
<div class="flex flex-col justify-center">
	...
	{:else}
		...
		{#if users.length > 0}
			<div
				class="scrollbar-hidden relative whitespace-nowrap w-full max-w-full"
			>
				<div
					class=" text-sm text-left text-gray-500 dark:text-gray-400 w-full max-w-full"
				>
					<!-- <div
					...
					<div class="w-full">
						{#each users as user, userIdx (user.id)}
							<div
								class=" dark:border-gray-850 text-xs flex items-center justify-between"
							>
								<div
									class="px-2 py-1.5 font-medium text-gray-900 dark:text-white flex-1"
								>
								...
								<div
									class="px-2 py-1 flex items-center gap-1 translate-y-0.5"
								>
									<div class=" ">
										<Badge
