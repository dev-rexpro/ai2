					...
					>
						<div class=" self-center flex items-center justify-center size-9">
							<img
								...
								class="sidebar-new-chat-icon size-6 rounded-lg group-hover:hidden"
								alt=""
							/>
		...
		>
			...
			>
				...
				>
					<img
						src="{REXPRO_BASE_URL}/static/favicon.png"
						class="sidebar-new-chat-icon size-6 rounded-lg"
						alt=""
					/>
				</a>
				...
				<a href="/" class="flex flex-1 px-0.5" on:click={newChatHandler}>
					<div
						id="sidebar-rexpro-name"
						class=" self-center font-medium text-lg text-gray-850 dark:text-white font-primary"
					>
						{$REXPRO_NAME}
					</div>
				</a>
