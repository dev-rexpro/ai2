		...
		if (tab === "") {
			...
			if (inputFiles) {
				...
				reader.onload = async (e) => {
					...
					toast.success(
						$i18n.t("Successfully imported {{userCount}} users.", {
							userCount: userCount,
						}),
					);
					inputFiles = null;
...
<Modal size="sm" bind:show>
	<div>
		...
		<div
			class="flex flex-col md:flex-row w-full px-4 pb-3 md:space-x-4 dark:text-gray-200"
		>
			<div
				...
				>
					...
					<div class="px-1">
						{#if tab === ""}
							...
							<hr
								class=" border-gray-100/30 dark:border-gray-850/30 my-2.5 w-full"
							/>
							...
							<div>
								...
								<div class=" text-xs text-gray-500">
									...
									<a
										...
										href="{REXPRO_BASE_URL}/static/user-import.csv"
									>
										{$i18n.t(
