<script lang="ts">
	...
	import { REXPRO_NAME, config, user, showSidebar } from "$lib/stores";
			...
			<tbody class="">
				{#each users as user, userIdx (user.id)}
					...
					>
						...
						<td
							class="px-3 py-1 font-medium text-gray-900 dark:text-white max-w-48"
						>
						...
						<td class=" px-3 py-1 max-w-48 truncate">
							{user.email}
						</td>
