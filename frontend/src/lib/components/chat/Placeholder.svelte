...
<div
	class="m-auto w-full max-w-6xl px-2 @2xl:px-20 translate-y-6 py-24 text-center"
>
	{#if $temporaryChatEnabled}
		...
		>
			...
			>
				<EyeSlash strokeWidth="2.5" className="size-4" />{$i18n.t(
					"Temporary Chat",
				)}
			</div>
		</Tooltip>
								...
								>
									...
									>
										<img
											...
											class=" size-9 @sm:size-10 rounded-xl border-[1px] border-gray-100 dark:border-none"
											aria-hidden="true"
											draggable="false"
											on:error={(e) => {
												e.currentTarget.src =
	...
	{:else}
		<div
			class="mx-auto max-w-2xl font-primary mt-2"
			in:fade={{ duration: 200, delay: 200 }}
		>
			<div class="mx-5">
				<Suggestions
