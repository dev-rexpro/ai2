...
<div class="flex flex-col self-start group">
	<div class="self-center flex">
		...
		>
			...
			<div
				class="absolute bottom-0 right-0 opacity-0 group-hover:opacity-100 transition"
			>
				<div
					class="p-1 rounded-full bg-white text-black border-gray-100 shadow"
				>
					<svg
	...
	<div class="flex flex-col w-full justify-center mt-2">
		<button
			...
			type="button"
			on:click={async () => {
				profileImageUrl = `${REXPRO_BASE_URL}/user.png`;
