<script lang="ts">
	...
	import { REXPRO_NAME, config, user, models, settings } from "$lib/stores";
		...
		<div class="mx-auto w-full md:px-0 h-full relative">
			<div class=" flex flex-col h-full">
				...
				<div class=" pb-[1rem]">
					{#if selectedContent}
						<div
							class="text-xs rounded-xl px-2.5 py-3 w-full markdown-prose-xs"
						>
							<blockquote>
					...
					>
						<div
							slot="menu"
							class="flex items-center justify-between gap-2 w-full pr-1"
						>
							<div>
								<Tooltip
									content={$i18n.t("Edit")}
