...
export const APP_NAME = 'rexpro-ai';
...
export const OPENAI_API_BASE_URL = `${REXPRO_BASE_URL}/openai`;
...
export const REXPRO_VERSION = APP_VERSION;
export const REXPRO_BUILD_HASH = APP_BUILD_HASH;
