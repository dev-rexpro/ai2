...
export const getUserGroups = async (token: string) => {
	...
	const res = await fetch(`${REXPRO_API_BASE_URL}/users/groups`, {
		method: 'GET',
		headers: {
...
export const updateUserRole = async (token: string, id: string, role: string) => {
	...
	const res = await fetch(`${REXPRO_API_BASE_URL}/users/update/role`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const getUserInfo = async (token: string) => {
	let error = null;
	const res = await fetch(`${REXPRO_API_BASE_URL}/users/user/info`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const getUserActiveStatusById = async (token: string, userId: string) => {
	...
	const res = await fetch(`${REXPRO_API_BASE_URL}/users/${userId}/active`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
