...
export const updateCalendar = async (
	...
	const res = await fetch(`${REXPRO_API_BASE_URL}/calendars/${calendarId}/update`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const setDefaultCalendar = async (
	...
	const res = await fetch(`${REXPRO_API_BASE_URL}/calendars/${calendarId}/default`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getCalendarEventById = async (
	...
	const res = await fetch(`${REXPRO_API_BASE_URL}/calendars/events/${eventId}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const rsvpCalendarEvent = async (
	...
	const res = await fetch(`${REXPRO_API_BASE_URL}/calendars/events/${eventId}/rsvp`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const searchCalendarEvents = async (
	...
	const res = await fetch(`${REXPRO_API_BASE_URL}/calendars/events/search?${params.toString()}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
