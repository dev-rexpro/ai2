...
export const streamPendingKnowledgeFiles = async (token: string, id: string) => {
	const res = await fetch(`${REXPRO_API_BASE_URL}/knowledge/${id}/files/pending?stream=true`, {
		method: 'GET',
		headers: {
...
export const addFileToKnowledgeById = async (
	...
	const res = await fetch(`${REXPRO_API_BASE_URL}/knowledge/${id}/file/add`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateFileFromKnowledgeById = async (token: string, id: string, fileId: string) => {
	...
	const res = await fetch(`${REXPRO_API_BASE_URL}/knowledge/${id}/file/update`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
